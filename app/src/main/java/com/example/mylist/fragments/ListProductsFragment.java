...
public class ListProductsFragment extends Fragment {
    ...
    public void onViewCreated(final @NonNull View view,
        ...
        final List<Product> productList = database.productDao()
                                                  .getAllProducts();
        ...
        binding.fabAddProduct.setOnClickListener(v -> NavHostFragment.findNavController(ListProductsFragment.this)
